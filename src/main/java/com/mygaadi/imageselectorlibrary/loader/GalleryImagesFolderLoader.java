 ...
 */
public class GalleryImagesFolderLoader extends AsyncTaskLoader<List<BucketItemModal>> {
    /**
     ...
     * @param context
     */
    public GalleryImagesFolderLoader(Context context) {
        super(context);
    }
    ...
    public List<BucketItemModal> loadInBackground() {
        ...
        List<BucketItemModal> list = DataFetchUtils.getImageFolders(getContext());
        if (list == null) {
            list = new ArrayList<>();
        }
        mList = list;
...
//        }
     ...
     */
    @Override
    public void onCanceled(List<BucketItemModal> data) {
